...
public class KakaoPayService {
    ...
    public KakaoPayVo kakaoPayReady(KakaoPayReadyVo vo) {
        ...
        parameters.add("approval_url", "https://www.workstay.site/findspace/successbooking/"+vo.getNo()); // 성공 URL
        parameters.add("cancel_url", "https://spring.workstay.site/payment/cancel");   // 취소 URL
        parameters.add("fail_url", "http://spring.workstay.site/payment/fail");      // 실패 URL
    ...
    public KakaoPayVo kakaoPayReadyRoom(KakaoPayReadyVo vo) {
        ...
        parameters.add("vat_amount", "1000");     // 부가세
        parameters.add("tax_free_amount", "0");   // 비과세 금액
        parameters.add("approval_url", "https://www.workstay.site/findstay/successbooking/"+vo.getNo()); // 성공 URL
        parameters.add("cancel_url", "https://spring.workstay.site/payment/cancel");   // 취소 URL
        parameters.add("fail_url", "https://spring.workstay.site/payment/fail");      // 실패 URL
